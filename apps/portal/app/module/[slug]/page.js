...
export default function ModulePage({ params }) {
  ...
  const [name, description] = catalog[params.slug] || ['Module','CyberOS module workspace'];
  useEffect(() => {
