  ...
  return (
    <div className="site-shell">
      <header className="site-nav">
        ...
        <div className="site-actions"><Link href="/login" className="site-secondary">Command Center</Link><a href="#demo" className="site-primary">Explore Demo →</a></div>
      </header>
      ...
      <main>
        ...
        <section className="demo-section" id="demo"><div><span className="site-eyebrow">DEMO WORLD</span><h2>See the operating model before you connect anything.</h2><p>Register a demo organization, select a limited asset scope such as a firewall, router, switch or server, then run synthetic hardening, vulnerability or standards-readiness assessments before connecting a real customer-controlled agent.</p><Link href="/login" className="site-primary large">Launch limited demo →</Link></div><div className="demo-list"><div><b>01</b><span>Sign in and register a demo organization</span></div><div><b>02</b><span>Select a limited asset and security module</span></div><div><b>03</b><span>Run a safe synthetic security assessment</span></div><div><b>04</b><span>Generate standards-mapped findings and report</span></div></div></section>
