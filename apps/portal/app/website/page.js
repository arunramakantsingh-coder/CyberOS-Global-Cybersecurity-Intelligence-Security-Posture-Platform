  ...
  return (
    <div className="site-shell">
      <header className="site-nav">
        <Link href="/" className="site-brand"><span className="site-mark">C</span><span><b>CYBEROS</b><small>GLOBAL SECURITY PLATFORM</small></span></Link>
        ...
        <div className="site-actions"><Link href="/command-center" className="site-secondary">Command Center</Link><a href="#demo" className="site-primary">Explore Demo →</a></div>
      </header>
      <main>
        <section className="hero" id="platform"><div className="hero-copy"><span className="site-eyebrow">CYBERSECURITY OPERATING PLATFORM</span><h1>One control plane for your entire security program.</h1><p>CyberOS brings threat intelligence, attack surface, vulnerabilities, security posture, compliance, authorized assessments, evidence, remediation and Cyber AI into one tenant-aware security operating platform.</p><div className="hero-actions"><a href="#demo" className="site-primary large">Enter Demo World →</a><a href="#modules" className="site-secondary large">Explore the platform</a></div><div className="hero-note"><span className="pulse"></span>Built around authorization, evidence, tenant isolation and auditable security operations.</div></div><div className="hero-console"><div className="console-top"><span>CYBEROS / SECURITY CONTROL PLANE</span><span className="console-status">● OPERATIONAL</span></div><div className="console-score"><span>ORGANIZATION SECURITY VIEW</span><strong>Unified</strong><small>Threat · Exposure · Posture · Compliance</small></div><div className="console-grid"><div><b>Assets</b><strong>360°</strong><small>security context</small></div><div><b>Findings</b><strong>Prioritized</strong><small>risk-aware</small></div><div><b>Evidence</b><strong>Linked</strong><small>audit-ready</small></div><div><b>Execution</b><strong>Gated</strong><small>policy-controlled</small></div></div><div className="console-flow"><span>Discover</span><i>→</i><span>Analyze</span><i>→</i><span>Assess</span><i>→</i><span>Remediate</span><i>→</i><span>Prove</span></div></div></section>
